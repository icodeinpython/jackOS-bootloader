...
.vesa_bios_info_verified:
    ...
    ; call Real_mode_println
    ; call Real_mode_println_nl

    ; mov cx, 34
    ; mov bx, di
    ; call Real_mode_println_hex_cx
    ; call Real_mode_println_nl
...
STR_VBE2 db "VBE2"
STR_VESA db "VESA"
MSG_VESA_VERSION dw 14
    db "VESA version: "
MSG_VESA_SELECT_SUCCESS dw 25
    db "Select VESA mode success!"
MSG_VESA_BIOS_FAILED dw 27
    db "VESA BIOS operation failed!"
MSG_VESA_NO_MATCHED_MODE dw 33
    db "No VESA mode satisfying criteria!"